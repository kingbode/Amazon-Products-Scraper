...
def get_Product_Profile(driver_,ASIN_):
    ...
    if amazon_page_:
        ...
        try:
            ...
            Product_Price = 'None << means not available'
    ...
    while True:   # <==== for Positive Reviews
        try:
            myElem = WebDriverWait(driver_, delay_).until(
                ...
                EC.presence_of_element_located((By.XPATH, '//*[@id="cm_cr-pagination_bar"]/ul/li[2]/a')))  # <==== new indication for Positive Reviews
...
def _save_Data_to_XLSX(_to_file,_Amazon_Product_Data,args):
